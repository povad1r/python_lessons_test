...
async def set_film_name(message: types.Message, state: FSMContext):
    ...
    if len(message.text) > 64:
        ...
        films[film_name] = {}
        file = open('semester1/lesson26/test.txt', 'a', encoding='utf-8')
        file.write(f'[\n   Name: {film_name},\n')
        file.close()
...
async def set_site_url(message: types.Message, state: FSMContext):
    ...
    file = open('semester1/lesson26/test.txt', 'a')
    file.write(f'   URL: {film_site_url},\n')
    file.close()
...
async def set_description(message: types.Message, state: FSMContext):
    ...
    file = open('semester1/lesson26/test.txt', 'a', encoding='utf-8')
    file.write(f'   Description: {film_description},\n')
    file.close()
...
async def set_rating(message: types.Message, state: FSMContext):
    ...
    file = open('semester1/lesson26/test.txt', 'a')
    file.write(f'   Rating: {film_rating},\n')
    file.close()
